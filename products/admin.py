...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("🖼️ Imagem e Visibilidade", {
            "fields": ("thumb_preview", "image", "is_featured", "is_active", "order"),
        }),
        ("📅 Datas", {
    ...
    def thumb(self, obj):
        ...
        return format_html(
            '<div style="width:50px;height:50px;background:#f3f4f6;border-radius:8px;'
    ...
    def thumb_preview(self, obj):
        if obj.image:
            return format_html(
                '<img src="{}" style="max-height:180px;max-width:280px;'
    ...
    def price_display(self, obj):
        if obj.has_discount:
            return format_html(
                '<span style="font-weight:700;color:#16a34a;">R$ {}</span> '
                '<span style="text-decoration:line-through;color:#9ca3af;font-size:0.85em;">R$ {}</span>',
